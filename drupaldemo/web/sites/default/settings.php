 ...
 * @endcode
 */
$settings['hash_salt'] = 'I5LVK8hdohSdNSl3WVE5nzUnFOs0iFStcaaWQ3o9WlPHP17KAaonDD4ybhfPc2ovppG2TgeBfA';
...
if (isset($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR']) && file_exists($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_drupaldemo_dd.inc')) {
  require $_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_drupaldemo_dd.inc';
}
// </DDSETTINGS>
...
$settings['config_sync_directory'] = 'sites/drupaldemo.dd/files/config_nMCVMRphwK5y56rlHiEiuvxMbAp8DOWZ_WAxk24-zIJrxYbpktH1u-QOH9CuF4FQscIBEZQLJA/sync';
